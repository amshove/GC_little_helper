 ...
 * @modified Skywalker90: Usage in Opera (2012)
  * @modified Skywalker90: Usage in Chrome (2012)
 * @created 2008-06-15
 * @updated 2011-07-28
...
var jscolorClass = function () {
	...
	this.fetchElement = function(mixed) {
		return typeof mixed === 'string' ? document.getElementById(mixed) : mixed;
	}


	this.addEvent = function(el, evnt, func) {
	...
	this.fireEvent = function(el, evnt) {
		if(!el) {
			return;
		}
	...
	this.getRelMousePos = function(e) {
		var x = 0, y = 0;
		if (!e) { e = window.event; }
	...
	this.URI = function(uri) { // See RFC3986
	...
	this.color = function(target, prop) {
...
window.jscolor = new jscolorClass();
